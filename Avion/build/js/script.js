...
/* harmony import */ var _helpers_getFontSize__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers/getFontSize */ "./src/js/helpers/getFontSize.js");

var calcHeight = function calcHeight() {
  var calculateHeight = function calculateHeight() {
    document.documentElement.style.setProperty('--app-height', "".concat(window.innerHeight / (0,_helpers_getFontSize__WEBPACK_IMPORTED_MODULE_0__["default"])(), "rem"));
  };
  calculateHeight();
...
var getFontSize = function getFontSize() {
  ...
  var fz = window.getComputedStyle(el, null).getPropertyValue('font-size');
  return parseFloat(fz);
};
/* harmony default export */ __webpack_exports__["default"] = (getFontSize);
...
/* harmony import */ var _helpers_isMobile__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers/isMobile */ "./src/js/helpers/isMobile.js");




var cursor = function cursor() {
  if (_helpers_isMobile__WEBPACK_IMPORTED_MODULE_3__["default"].any()) {
    document.querySelectorAll('.aura, .cursor2').forEach(function (item) {
      return item.remove();
    });
    return;
  }
  var aura = document.querySelector('.aura');
  var cursorPointer = document.querySelector('.cursor2');
  var buttons = document.querySelectorAll('a, button');
  document.addEventListener('pointermove', function (e) {
    var x = e.clientX;
    var y = e.clientY;
    aura.style.transform = "translate3d(calc(".concat(x / 16, "rem - 50%), calc(").concat(y / 16, "rem - 50%), 0)");
    cursorPointer.style.left = "".concat(x / 16, "rem");
    cursorPointer.style.top = "".concat(y / 16, "rem");
  });
...
var filters = function filters() {
  var filterBtn = document.querySelector('#product-filter');
  var aside = document.querySelector('.product-listings__aside');
  var filterCloseButton = document.querySelector('#product-listings-close');
  var productApply = document.querySelector('#product-apply');
  if (!filterBtn) return;
  ...
  filterBtn.addEventListener('click', function () {
    ...
    (0,scroll_lock__WEBPACK_IMPORTED_MODULE_0__.addScrollableSelector)('.product-listings__aside');
  });
...
var footer = function footer() {
  ...
  if (!footerEl) return;
  var calcHeight = function calcHeight() {
    document.documentElement.style.setProperty('--app-footer-height', "".concat(footerEl.clientHeight / 16, "rem"));
  };
  calcHeight();
...
var header = function header() {
  ...
  var calcHeight = function calcHeight() {
    document.documentElement.style.setProperty('--app-header-height', "".concat(headerEl.clientHeight / 16, "rem"));
  };
  if (headerEl) {
    calcHeight();
    window.addEventListener('resize', calcHeight);
  ...
  var headerBurger = document.querySelector('[data-burger]');
  ...
  headerBurger.addEventListener('click', function () {
    ...
    (0,scroll_lock__WEBPACK_IMPORTED_MODULE_0__.disablePageScroll)();
    (0,scroll_lock__WEBPACK_IMPORTED_MODULE_0__.addScrollableSelector)('.header__nav');
  });
  ...
  var setHeaderSmall = function setHeaderSmall() {
    if (window.scrollY > 0) headerEl.classList.add('header--small');else headerEl.classList.remove('header--small');
  };
  var getMedia = function getMedia() {
    var mql = window.matchMedia('(max-width: 47.9875em)');
    if (mql.matches) {
...
var sliders = function sliders() {
  var bannerSlider = document.querySelector('.banner__slider');
  if (bannerSlider) {
  ...
  if (productSlider) {
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](productSlider, {
      slidesPerView: 1,
      speed: 700,
      loop: true
    });
...
/*!************************!*\
  ...
  \************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _helpers_calcHeight__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers/calcHeight */ "./src/js/helpers/calcHeight.js");
...
/* harmony import */ var _modules_footer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/footer */ "./src/js/modules/footer.js");
...
/* harmony import */ var _modules_filters__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/filters */ "./src/js/modules/filters.js");
/* harmony import */ var _modules_cursor__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/cursor */ "./src/js/modules/cursor.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_helpers_calcHeight__WEBPACK_IMPORTED_MODULE_0__["default"])();
  (0,_modules_header__WEBPACK_IMPORTED_MODULE_1__["default"])();
  (0,_modules_sliders__WEBPACK_IMPORTED_MODULE_3__["default"])();
  (0,_modules_footer__WEBPACK_IMPORTED_MODULE_2__["default"])();
